...
function Formal() {
    ...
    return (
        ...
        <div className='pt-5 px-3'>
            <p className='pt-2' style={{color:"#6f6f6f"}}>HOME <span className='ml-2'> <AiFillCaretRight/> </span><span className='ml-2 pb-1' style={{color:"black",borderBottom:"1px solid black"}}>FORMALS</span></p>
        ...
        {
            formal.Formal.map((e,i)=>{
                return <div className='px-3 col-lg-4 col-md-6 col-12' style={{height:"auto",display:"grid",}} onClick={()=>{handleDetail(i)}}>
