...
function Prints() {
    const [jhirki]=useState(ApiData)
    return (
        <div className=' px-2'>
        <div className='pt-5 px-3'>
            <p className='pt-2' style={{color:"#6f6f6f"}}>HOME <span className='ml-2'> <AiFillCaretRight/> </span><span className='ml-2 pb-1' style={{color:"black",borderBottom:"1px solid black"}}>JHIRKI BLOCK PRINTS</span></p>
