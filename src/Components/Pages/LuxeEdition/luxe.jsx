...
function Luke() {
    const [luxe]=useState(ApiData)
    return (
        <div className=' px-2'>
        <div className='pt-5 px-3'>
            <p className='pt-2' style={{color:"#6f6f6f"}}>HOME <span className='ml-2'> <AiFillCaretRight/> </span><span className='ml-2 pb-1' style={{color:"black",borderBottom:"1px solid black"}}>LUXURY PRET</span><span className='ml-2'> <AiFillCaretRight/> </span><span className='ml-2 pb-1' style={{color:"black",borderBottom:"1px solid black"}}>LUXE EDITION</span></p>
            ...
            luxe.Arrival.map(e=>{
                return <div className='px-3 col-lg-4 col-md-6 col-12' style={{height:"auto",display:"grid",}}>
                    <div className='border g-grid imgParents'>
                        ...
                        <button className="mr-4 mt-1 px-3 py-2" style={{position:"absolute",top:"0px",right:"0px",border:"none",zIndex:"5",background:"green",color:"white"}}>{e.CATEGORY}</button>
