...
function Bridals() {
    const [bridal]=useState(ApiData)
    return (
        <div className=' px-2'>
        <div className='pt-5 px-3'>
        <p className='pt-2' style={{color:"#6f6f6f"}}>HOME<span className='ml-2'> <AiFillCaretRight/> </span><span className='ml-2 pb-1' style={{color:"black",borderBottom:"1px solid black"}}>BRIDALS</span></p>
            <div className='pt-3' style={{height:"6vh"}}>
                <img src={FilterImg} alt="filter-logo"/>
            ...
            bridal.Bridal.map(e=>{
                return <div className='px-3 col-lg-4 col-md-6 col-12' style={{height:"auto",display:"grid",}}>
                    <div className='border g-grid imgParents'>
                        <img src={e.productImg1} style={{position:"relative"}} className='w-100 border' alt="" />
                        <img src={e.productImg2} style={{position:"absolute",top:"0px",left:"0px",width:"94.5%",zIndex:"3"}} className='border ml-3 imgHover' alt="" />
